...
?>
    ...
    <div class="col-md-4">
        ...
        <input id="ex6" type="text" data-slider-min="0" data-slider-max="20" data-slider-step="1" data-slider-value="3" data-slider-tooltip="hide"/ data-slider-enabled="true">
        <span id="ex6CurrentSliderValLabel">Valor Slider: <span id="ex6SliderVal">3</span></span>
       <!--  <span id="ex6CurrentSliderValLabel">Valor Slider: <span id="ex6SliderVal">3</span></span> -->
        <br>
